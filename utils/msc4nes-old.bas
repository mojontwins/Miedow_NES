...
if command (1) = "" or	maxidx = 0 then
	...
	Print
	print "uso: msc4nes input n_pants"
	print ""
...
'Print #f3, "// Copyleft 2017 The Mojon Twins"
'Print #f3, ""
...
Print #f2, "unsigned char *next_script;"
Print #f2, "unsigned char *script;"
...
if actionsUsed (&H20) Then
	...
	print #f2, "						*ul = NT_UPD_EOF; ppu_wait_nmi ();"
	print #f2, "						break;"
End If
