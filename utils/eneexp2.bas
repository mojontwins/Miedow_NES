...
Dim As Integer typeCounters (255), totalCounter
...
For i = 1 To (mapPants * nEnems)
	Get #fIn, , t
	If t <> 0 Then totalCounter = totalCounter + 1
	Get #fIn, , a: Get #fIn, , b
	Get #fIn, , a: Get #fIn, , b
	Get #fIn, , mn
	Get #fIn, , d: Get #fIn, , d
...
Print #fOut, ""
Print #fOut, "// Map is " & mapW & "x" & mapH & " (" & mapPants & " screens)"
Print #fOut, ""
...
If totalCounter > 0 Then
	...
	Print #fOut, "};"
Else 
	Print #fOut, "// This level doesn't seem to have enemies..."
	For i = 1 To (mapPants * nEnems)
		Get #fIn, , t
		Get #fIn, , a: Get #fIn, , b
		Get #fIn, , a: Get #fIn, , b
